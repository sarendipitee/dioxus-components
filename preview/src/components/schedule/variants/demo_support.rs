...
/// Returns the shared reference date used by schedule preview variants.
pub(super) fn sample_date() -> Date {
    date!(2026 - 05 - 12)
}

/// Returns the shared sample events rendered by schedule preview variants.
...
/// Returns a workday-oriented time grid configuration used by several preview variants.
...
/// Returns localized French labels used by the internationalized preview variant.
