        ...
        SidebarMenu {
            SidebarMenuItem {
                DropdownMenu {                    DropdownMenuTrigger {                        as: move |attributes: Vec<Attribute>| rsx! {
                    ...
                    Menu {                        div { style: "padding:0.5rem; font-size:var(--text-xs); opacity:0.7;",
                            "Teams"
                        }
        ...
        SidebarMenu {
            SidebarMenuItem {
                DropdownMenu {                    DropdownMenuTrigger {                        as: move |attributes: Vec<Attribute>| rsx! {
                    ...
                    Menu {                        div { style: "display:flex; align-items:center; gap:0.5rem; padding:0.375rem 0.25rem; text-align:left; font-size:var(--text-sm);",
                            ImageAvatar {
                                size: AvatarImageSize::Small,
                                style: "border-radius:0.5rem;",
                                src: asset!("/assets/dioxus-logo.png").to_string(),
