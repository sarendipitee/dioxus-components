...
#[path = "../../../preview/src/components/virtual_list/demos/random_heights/mod.rs"]
mod demo_random_heights;

#[path = "../../../preview/src/components/virtual_list/demos/states/mod.rs"]
mod demo_states;
...
fn BlockView() -> Element {
    ...
    match hash().as_str() {
        ...
        "random_heights" => rsx! { demo_random_heights::Demo {} },
