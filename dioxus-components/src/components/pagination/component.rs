...
pub fn Pagination(
    ...
    rsx! {
        nav {
            class: Styles::dx_pagination.to_string(),
...
pub fn PaginationContent(
    ...
    rsx! {
        ul {
            class: Styles::dx_pagination_content.to_string(),
...
pub fn PaginationLink(props: PaginationLinkProps) -> Element {
    ...
    rsx! {
        a {
            class: Styles::dx_pagination_link.to_string(),
...
pub fn PaginationPrevious(
    ...
    rsx! {
        PaginationLink {
            ...
            span { class: Styles::dx_pagination_label.to_string(), "Previous" }
        }
    }
}
...
pub fn PaginationNext(
    ...
    rsx! {
        PaginationLink {
            ...
            onmouseup,
            attributes,
            span { class: Styles::dx_pagination_label.to_string(), "Next" }
...
pub fn PaginationEllipsis(
    ...
    rsx! {
        span {
            class: Styles::dx_pagination_ellipsis.to_string(),
            "data-slot": "pagination-ellipsis",
            aria_hidden: "true",
            ..attributes,
            Ellipsis { size: "1rem" }
            span { class: Styles::dx_sr_only.to_string(), "More pages" }
        }
    }
}
