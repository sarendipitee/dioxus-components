...
pub fn ColorPickerRoot(props: ColorPickerRootProps) -> Element {
    ...
    rsx! {
        color_picker::ColorPicker {
            class: Styles::dx_color_picker.to_string(),
            color: props.color,
...
pub fn ColorPickerTrigger(props: ColorPickerTriggerProps) -> Element {
    ...
    rsx! {
        popover::PopoverTrigger {
            class: Styles::dx_color_picker_button.to_string(),
...
fn ColorField(props: ColorFieldProps) -> Element {
    ...
    rsx! {
        div {
            class: Styles::dx_color_field_container.to_string(),
            ..props.attributes,
            if let Some(label) = props.label {
                Label {
                    html_for: "color_field",
                    class: Styles::dx_color_slider_title.to_string(),
                    {label}
                }
            }
            Input {
            ...
            if let Some(text) = props.description {
                span { class: Styles::dx_color_field_description.to_string(), {text} }
            }
            {props.children}
        }
    }
    ...
    rsx! {
        ...
        div {
            ...
            Slider {
                ...
                SliderTrack {
                    class: Styles::dx_color_slider_track.to_string(),
                    SliderThumb {
    ...
    rsx! {
        color_picker::ColorArea {
            ...
            color_picker::AreaTrack {
                class: Styles::dx_color_area_track.to_string(),
                color_picker::AreaThumb {
                    class: Styles::dx_color_area_thumb.to_string(),
                    color_picker::AreaThumbSaturationInput {
                        class: Styles::dx_color_area_input.to_string(),
                    }
...
pub fn ColorPickerSelect(props: ColorPickerSelectProps) -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                class: Styles::dx_color_picker_input.to_string(),
