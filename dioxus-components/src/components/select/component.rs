...
use dioxus_primitives::select::{
    self, SelectGroupLabelProps, SelectListProps, SelectMultiProps, SelectOptionProps, SelectProps,
    SelectTriggerProps,
};
...
pub fn Select<T: Clone + PartialEq + 'static>(props: SelectProps<T>) -> Element {
    ...
    rsx! {
        select::Select {
            ...
            select::SelectList {
                class: Styles::dx_select_list.to_string(),
                {props.children}
            }
        }
    }
...
/// A styled trigger for custom [`Select`] and [`SelectMulti`] compositions.
#[component]
...
/// A styled option list for custom [`Select`] and [`SelectMulti`] compositions.
#[component]
