...
pub fn Sheet(props: DialogRootProps) -> Element {
    let content_base = attributes!(div {
        class: Styles::dx_sheet.to_string(),
    ...
    rsx! {
        dialog::DialogRoot {
            class: Styles::dx_sheet_root.to_string(),
...
pub fn SheetContentClose(
    ...
    let base = attributes!(button {
        class: Styles::dx_sheet_close.to_string(),
    });
...
pub fn SheetHeader(
    ...
    rsx! {
        div { class: Styles::dx_sheet_header.to_string(), "data-slot": "sheet-header", ..attributes, {children} }
    }
}
...
pub fn SheetFooter(
    ...
    rsx! {
        div { class: Styles::dx_sheet_footer.to_string(), "data-slot": "sheet-footer", ..attributes, {children} }
    }
}
...
pub fn SheetTitle(props: DialogTitleProps) -> Element {
    rsx! {
        dialog::DialogTitle {
            id: props.id,
            class: Styles::dx_sheet_title.to_string(),
...
pub fn SheetDescription(props: DialogDescriptionProps) -> Element {
    rsx! {
        dialog::DialogDescription {
            id: props.id,
            class: Styles::dx_sheet_description.to_string(),
